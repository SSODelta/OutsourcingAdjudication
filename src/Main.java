...
public class Main {
    ...
    public static void threshold(int samples) throws IOException {
        System.out.println(timestamp()+"Starting work on threshold payment function, with "+samples+" samples.");
    ...
    public static void awardLossSharing(int samples) throws IOException {
        System.out.println(timestamp()+"Starting work on award/loss sharing payment function, with "+samples+" samples.");
